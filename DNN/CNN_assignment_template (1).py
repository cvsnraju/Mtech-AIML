...
1. FILENAME FORMAT: <Group_ID>_cnn_assignment.ipynb
   Example: GROUP_01_cnn_assignment.ipynb
   ❌ Wrong filename = Automatic 0 marks

2. STUDENT INFORMATION MUST MATCH:
   ✓ GROUP ID in filename = GROUP ID in notebook (above)
...
□ Filename is <GROUP_ID>_cnn_assignment.ipynb
